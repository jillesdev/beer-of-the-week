...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { description: @beer.description, name: @beer.name, picture: @beer.picture, price: @beer.price, score: @beer.score }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { description: @beer.description, name: @beer.name, picture: @beer.picture, price: @beer.price, score: @beer.score }
    assert_redirected_to beer_path(assigns(:beer))
  end
